...
namespace SomerenDAL
{
    public abstract class Base
    {
        ...
        protected Revenue ExecuteSelectQuerySUM(String query, params SqlParameter[] sqlParameters)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (reader[0].ToString() == null || reader[0].ToString() == "")
                    {
                        ...
                        newrevenue.Afzet = 0;
                        newrevenue.Omzet = 0;
                        newrevenue.AantalBestellingen = 0;

                    }
                    else
                    {
                        newrevenue.Afzet = int.Parse(reader[0].ToString());
                        newrevenue.Omzet = int.Parse(reader[1].ToString());
                        newrevenue.AantalBestellingen = int.Parse(reader[2].ToString());
                    }
                }
            }
            catch (SqlException e)
